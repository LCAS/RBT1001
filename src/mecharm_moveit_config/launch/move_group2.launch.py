...
def generate_launch_description():
    ...
    package_name_moveit_config = 'mecharm_moveit_config'
    ...
    urdf_file_path = 'config/firefighter.urdf.xacro'
    srdf_file_path = 'config/firefighter.srdf'
    ...
    # Set the full paths
    urdf_model_path = os.path.join(pkg_share_moveit_config, urdf_file_path)
    ...
    moveit_config = (
        MoveItConfigsBuilder("firefighter", package_name=package_name_moveit_config)
