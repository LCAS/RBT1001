...
class MinimalPublisher(Node):
    ...
    def js_cb(self, msg):
        ...
        if len(self.joint_idx) == 0:
            ...
            self.get_logger().info("{}".format(self.joint_idx))
            self.get_logger().info("{}".format(msg.position[self.joint_idx["arm_1_joint"]]))
            self.get_logger().info("{}".format(msg.position[self.joint_idx["arm_2_joint"]]))
            self.get_logger().info("{}".format(msg.position[self.joint_idx["arm_3_joint"]]))
            self.get_logger().info("{}".format(msg.position[self.joint_idx["arm_4_joint"]]))
            self.get_logger().info("{}".format(msg.position[self.joint_idx["arm_5_joint"]]))
            self.get_logger().info("{}".format(msg.position[self.joint_idx["arm_6_joint"]]))
            self.get_logger().info("{}".format(msg.position[self.joint_idx["arm_7_joint"]]))
